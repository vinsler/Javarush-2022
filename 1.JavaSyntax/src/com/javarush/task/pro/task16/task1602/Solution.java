...
/*
Подчищаем хвосты
Метод fixDate принимает в качестве параметра список дат. Некоторые из них содержат две типичные ошибки: неправильно сохраняются (и, следовательно, выводятся в консоли) год и месяц.
...
public class Solution {
    ...
    static void fixDate(List<Date> brokenDates) {
        ...
        for (Date date : brokenDates) {
            ...
            // wtf да что за условия смайл молотком по голове
        }
    }
}
