...
public class Solution {
    ...
    public static Optional<Car> getMostExpensiveCar(Stream<Car> cars) {
        ...
        return cars.max((m1, m2) -> (m1.getPrice() - m2.getPrice()));
    }

    public static Optional<Car> getMoreExpensiveCar(Stream<Car> cars, Car mostExpensiveCar) {
        //напишите тут ваш код
        //cars.findFirst().filter(s -> s.getPrice() > mostExpensiveCar.getPrice());
        //cars.filter(s -> s.getPrice() > mostExpensiveCar.getPrice()).findFirst();
